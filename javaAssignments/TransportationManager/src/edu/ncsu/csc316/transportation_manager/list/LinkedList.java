...
/**
 * Credit from project 1 in CSC316
 */
/**
 * A class that implements a Linked List - a list of connections by pointers 
 * @author Eric McAllister
 *
 * @param <E> - any data type being represented currently by E 
 */
public class LinkedList<E> {
	...
	/**
	 * This method gets the object stored in a certain reference in the linked list based on when
	 *  it was added (the index)
	 * @param index - the location in the map that the object in reference is located 
	 * @return - the object that was stored in that index
	 */
//	public E get(int index) {
//		if(front == null || index < 0 || index > this.size() - 1) {
